...
const Try = () => {
    ...
    const get_Data = async () => {
        ...
        fetch(`http://kalanirdhari.in/get/singel/qst/${ip}`)
            .then(res => res.json())
            .then((res) => {
    ...
    const resumeCountdown = async () => {
        ...
        const updateSeconds = () => {
            ...
            if (remaining > 0) {
                ...
                if (!submitted) {
                    axios.post("http://kalanirdhari.in/time/out/by/singel/qst/data", {
                        ip
                    }).then(res => {
                        setShow("Time_Out");
                    }).catch(err => {
    ...
    const handleOptionClick = async (option) => {
        ...
        axios.post("http://kalanirdhari.in/get/singel/qst/ans", {
            ip,
            qno: data.qno,
            ans: option
        }).then(res => {
