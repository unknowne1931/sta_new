...
const View_qstn = () => {
    ...
    const Get_Data = () =>{
        try{
            api_user_admin.get(`http://kalanirdhari.in/get/admin/sub/users/posted/datas/011/${user}`)
            .then(res =>{
                if(res.data.data){
            ...
            <div>
                {data.map((user, i)=>{
                    ...
                    const DeleOne_fromId = () =>{
                        try{
                            setAlert(false)
                            api_user_admin.delete(`http://kalanirdhari.in/delete/users/admin/qno/from/admin/users/${user._id}`)
                            .then(res =>{
