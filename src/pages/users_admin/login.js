...
const Login = () => {
    ...
    const Post_Login = (e) =>{
      ...
      try{
        e.preventDefault();
        axios.post('http://192.168.31.133/get/and/login/users/admin/pages/auth',{username, password : pass})
        .then(res =>{
    ...
    const Verify_otp = (e) =>{
      ...
      setAlert(false)
      try{
        apiAdmin.post('http://192.168.31.133/verify/users/language/modele/and/otp', {otp, id : ssid})
        .then(res=>{
          if(res.data.Status === "OK"){
