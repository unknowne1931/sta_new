...
const Sel_question = () => {
    ...
    const fetchAllQuestions = () => {
        apiAdmin.get(`${process.env.REACT_APP_API_URL}/admin/get/tottal/users/created/questions`)
            .then(res => {
                if (res.data.data) {
    ...
    const handleSelectData = (question) => {
        ...
        apiAdmin.post(`${process.env.REACT_APP_API_URL}/get/data/and/post/users/selected/data/to/db`, {
            user: question.user,
            img: question.img,
