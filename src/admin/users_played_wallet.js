...
const UsersPlayedWalletAdmin = () => {
    ...
    function get_refund_ticket() {
        apiAdmin.get('http://192.168.126.1/admin/refund/tickets/list')
            .then((response) => {
    ...
    function get_referd_coin() {
        apiAdmin.get('http://192.168.126.1/admin/refund/data/list')
            .then((response) => {
                if (response.data.Logout === "OUT") {
    ...
    function get_paid_data() {
        apiAdmin.get('http://192.168.126.1/admin/balance/wallet')
            .then((response) => {
                if (response.data.Logout === "OUT") {
                    window.location.href = "/admin/login";
                } else if (response.data.data) {
