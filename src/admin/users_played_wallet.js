...
const UsersPlayedWalletAdmin = () => {
    ...
    function get_refund_ticket() {
        apiAdmin.get(`${process.env.REACT_APP_API_URL}/admin/refund/tickets/list`)
            .then((response) => {
    ...
    function get_referd_coin() {
        apiAdmin.get(`${process.env.REACT_APP_API_URL}/admin/refund/data/list`)
            .then((response) => {
                if (response.data.Logout === "OUT") {
    ...
    function get_paid_data() {
        apiAdmin.get(`${process.env.REACT_APP_API_URL}/admin/balance/wallet`)
            .then((response) => {
                if (response.data.Logout === "OUT") {
                    window.location.href = "/admin/login";
                } else if (response.data.data) {
