...
const Ac_upi = () => {
    ...
    const GetData = () =>{
        try{
            setTimeout(()=>{
                api.get(`${"https://kalanirdhari.in"}/get/bank/account/data`)
                .then(res =>{
                    if(res.data.data){
                        setIsData(true)
    ...
    const UPIpost = (e) =>{
        ...
        //     if(app !== ''){
        //         api.post(`${"https://kalanirdhari.in"}/bank/upi/data/collect`,{user, ac_h_nme : h_name, bank_nme : "No", Acc_no : acc_no, ifsc : "No", app , type : "UPI"})
        //         .then(res=>{
    ...
    const BankUp = (e) =>{
        ...
        e.preventDefault()
        try{
            api.post(`${"https://kalanirdhari.in"}/bank/upi/data/collect`,{user, ac_h_nme : h_name, bank_nme : bank, Acc_no : acc_no, ifsc, app : "No" , type : "BANK"})
            .then(res=>{
                if(res.data.Status === "OK"){
                    setData("Account Added")
                    setAlert(true)
