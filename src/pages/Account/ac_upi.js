...
const Ac_upi = () => {
    ...
    const get_reward = async () => {
        ...
        api.get(`http://kalanirdhari.in/get/singel/reward/data/by/${id}/${u_id}`)
        .then(res=>{
            if(res.data.data){
    ...
    const GetData = () =>{
        try{
            setTimeout(()=>{
                api.get(`${"http://kalanirdhari.in"}/get/bank/account/data/${user}`)
                .then(res =>{
                    if(res.data.data){
                        setIsData(true)
    ...
    const UPIpost = (e) =>{
        ...
        //     if(app !== ''){
        //         api.post(`${"http://kalanirdhari.in"}/bank/upi/data/collect`,{user, ac_h_nme : h_name, bank_nme : "No", Acc_no : acc_no, ifsc : "No", app , type : "UPI"})
        //         .then(res=>{
    ...
    const BankUp = (e) =>{
        ...
        e.preventDefault()
        try{
            api.post(`${"http://kalanirdhari.in"}/bank/upi/data/collect`,{user, ac_h_nme : h_name, bank_nme : bank, Acc_no : acc_no, ifsc, app : "No" , type : "BANK"})
            .then(res=>{
                if(res.data.Status === "OK"){
                    setData("Account Added")
                    setAlert(true)
